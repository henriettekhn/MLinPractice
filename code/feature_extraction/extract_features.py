...
parser.add_argument("-ec", "--exclamation_count", action = "store_true", help = "compute the number of ecxclamation marks in the tweet")
...
if args.import_file is not None:
    ...
    if args.char_length:
        ...
        # number of exclamation marks in the original tweet
